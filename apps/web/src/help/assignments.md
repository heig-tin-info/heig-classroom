...
An assignment distributes a **source repository** to every student as an individual **private repository**. The platform snapshots the source, students accept to get their copy, and grading runs inside their repository.
...
Edit the assignment and move the deadline into the future: repositories are unlocked, grading resumes until the new deadline, and the final review round is reset.
