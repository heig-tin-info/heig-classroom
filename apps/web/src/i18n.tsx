...
const en = {
  ...
  "staff.title": "Staff",
  "staff.empty": "You are alone on this classroom.",
  ...
  "settings.appearanceHint": "Interface style, stored in this browser.",
  "settings.theme.classic": "Classic",
  "settings.theme.v2": "Refined",
...
const fr: Record<keyof Dict, string> = {
  ...
  "staff.title": "Équipe",
  "staff.empty": "Vous êtes seul·e sur cette classe.",
  ...
  "settings.appearanceHint": "Style de l'interface, mémorisé dans ce navigateur.",
  "settings.theme.classic": "Classique",
  "settings.theme.v2": "Remanié",
