...
const en = {
  ...
  "assignment.col.lastName": "Last name",
  "assignment.col.firstName": "First name",
  "assignment.col.github": "GitHub",
...
const fr: Record<keyof Dict, string> = {
  ...
  "assignment.col.lastName": "Nom",
  "assignment.col.firstName": "Prénom",
  "assignment.col.github": "GitHub",
