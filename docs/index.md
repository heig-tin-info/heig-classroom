...
Start with [About](guide/about.md) for the why and the workflows, then
[GitHub applications](guide/github-apps.md) when you need to wire the portal to
an organization. The full requirements and architecture live in the
